...
class Mcp2210GpioConfiguration(ValidatedDataClass):
    ...
    def check_pin_number_is_gpio(self, pin_number: int):
        """
        Checks if the given pin number is configured as a GPIO.
    ...
    def get_gpio_direction_for_pin_number(self, pin_number: int):
        """
        ...
        """
        self.check_pin_number_is_gpio(pin_number)
        return (self.gpio_direction & (1 << pin_number)) >> pin_number
...
class Mcp2210(object):
    ...
    def _execute_command(self, request: bytes, pad_with_zeros: bool = True, check_return_code: bool = True):
        """
